        ...
        <div class="content_wrapper">
            ...
            <div class="mypage_sidebar">
                ...
                <nav class="mypage_menu">
                    ...
                    <a href="myGTRHistory.do" class="mypage_menu_item active">게스더랭크 기록</a>
            ...
            <div class="mypage_user_section">
                <h2 class="mypage_section_title">게스더랭크 기록</h2>
                
                <div class="mypage_gtr_container">
