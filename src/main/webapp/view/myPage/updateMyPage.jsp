    ...
    <div class="main_content">
        ...
        <form action="updateMyPageOK.do" method="post" enctype="multipart/form-data">
            <c:if test="${empty file.originalFileName}">
                <img
                        class="oldFile" id="previewImage" src="img/common/empty.png" width="200"
                        height="200" style="border-radius: 100%;"
                > <br>
            </c:if>
            <c:if test="${!empty file.originalFileName}">
                <img
                        class="oldFile" id="previewImage" src="${file.fileUrl}" width="200"
                        height="200" style="border-radius: 100%;"
                > <br>
            </c:if>
            이름 :
            ...
            <br>
            사용자닉네임 : <input
                type="text" name="userNickname" id="userNickname" value="${user.userNickname }"
                required
        > <br>
